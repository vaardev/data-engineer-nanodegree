...
def process_song_file(cur, filepath):
    """
        This function reads JSON files information of song and artist data and saves into song and artist tables.
        Arguments:
...
def process_log_file(cur, filepath):
    ...
    """
        This function reads Log files and information of time, user and songplay data and saves into time, user,songplay tables
        Arguments:
        cur (psycopg2.cursor()): Cursor of the sparkifydb database
    ...
    time_data = []
    for line in t:
        time_data.append([line, line.hour, line.day, line.week, line.month, line.year, line.weekday()])
